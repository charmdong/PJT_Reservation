    ...
    <div id="container" data-display-info-id="${displayInfoId}">
        ...
        <div class="ct main">
            <div>
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            <span class="num">1</span><!-- 1,2로 왔다리 갔다리-->
                ...
                <div class="section_btn"> <button type="button" class="bk_btn" onclick="location.href='reserve?displayInfoId=${displayInfoId}'"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
                        ...
                        <div class="detail_info">
                                ...
                                <ul class="detail_info_group">
                                    <li class="detail_info_lst">
                                        ...
                                        <p class="in_dsc"><!--prodict_description-->
                                        </p>
                                    </li>
