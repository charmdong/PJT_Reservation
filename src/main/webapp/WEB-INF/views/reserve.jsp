...
<body>
    <div id="container" data-display-info-id="${displayInfoId}" data-reservation-date="${randReservationDate}">
            ...
            <div class="ct_wrap">
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit"></h3>
                        <p class="dsc">
                            장소 : <br> 기간 : 2019.7.1.(월)~2019.8.30.(금)
                        </p>
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        ...
                                        <div class="warning_msg">연락처 형식을 다시 확인해주세요.</div>
                                    </div>
                                </div>
