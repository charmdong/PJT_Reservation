...
<body>
	<div id="container" data-reservation-info-id=${reservationInfoId} data-product-id=${productId}>
		...
		<div class="ct">
			<div class="ct_wrap">
				...
				<!-- //리뷰 입력 -->
            <form class = "review_content" method = "post" enctype = "multipart/form-data">
				<!-- 리뷰 작성 푸터 -->
